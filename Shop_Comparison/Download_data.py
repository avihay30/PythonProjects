...
class StoreDataBase(object):
    ...
    def _shufersal_downloader(self, driver):
        ...
        store_drawer = driver.find_element_by_xpath('//*[@id="ddlStore"]')
        store_drawer.send_keys(self.store_number)
        # store_drawer_select = driver.find_element_by_xpath(f'//*[@id="ddlStore"]/option[{self.store_number + 1}]')
        # store_drawer_select = driver(f'//*[@id="ddlStore"]/option[{self.store_number + 1}]')
